...
import {
  ...
  Calculator, BarChart3, Upload, Settings, LogOut, Sparkles,
} from "lucide-react";
import {
  ...
  return (
    <Sidebar collapsible="icon" className="border-r border-sidebar-border">
      ...
      <SidebarFooter className="p-2">
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton onClick={signOut} tooltip="Sair" className="text-sidebar-foreground/70 hover:text-destructive">
